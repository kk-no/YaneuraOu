...
const pkgobjs = [
  {
    ...
    exportname: "YaneuraOu",
    extra: "ENGINE_NAME=YaneuraOu EVAL_EMBEDDING=ON EM_INITIAL_MEMORY_SIZE=167772160 EXTRA_CPPFLAGS='-DENGINE_OPTIONS=\\\"\"option=name=FV_SCALE=type=spin=default=24=min=1=max=128\\\"\"'",
    evalfile: true,
  },
  // {
  //   name: "k-p",
